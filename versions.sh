...
DOLIBARR_VERSIONS=("15.0.3" "16.0.5" "17.0.4" "18.0.9" "19.0.4" "20.0.4" "21.0.4" "22.0.5" "23.0.4" "24.0.0" "develop")

# The version to use when installing dolibarr/dolibarr:latest
DOLIBARR_LATEST_TAG="24.0.0"

# The version to use to find the dump file for the init of demo with branch "develop"
DOLIBARR_VERSION_FOR_INIT_DEMO="24.0"
